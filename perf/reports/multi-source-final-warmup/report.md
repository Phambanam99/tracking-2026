...
- Date: `2026-03-01T14:04:13+07:00`
- Commit: `a591841`
- Environment: `docker-e2e`
- Run dir: `perf/reports/multi-source-final-warmup`
...
| Metric | Latest value |
|---|---|
| ingestion records rate | 10911.471593802285 |
| ingestion publish rate | 10911.471593802285 |
| ingestion admission reject rate | 0 |
| processing pipeline p95 | 0.0009503040973111394 |
| processing DLQ rate | 0 |
| ingestion publish failed rate | 0 |
| storage batch p95 | 1.0489856402285715 |
...
- PASS / FAIL: PASS - expected-status avg 100.00%, total 2xx=1201, 4xx=0, 5xx=0, max p95=7.30ms
